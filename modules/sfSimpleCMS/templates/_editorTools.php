...
<div id="editor_box">
  ...
  <div id="cms_toolbox_mode">
    ...
    <div>
      ...
      <?php if ($page->getIsPublished()): ?>
        ...
        <span class="unpublished"><?php echo link_to(__('unpublish'), 'sfSimpleCMS/togglePublish?slug='.$slug, array('query_string' => $query_string.'&sf_culture='.$culture)) ?></span>
      <?php else: ?>
        <span class="published"><?php echo link_to( __('publish'), 'sfSimpleCMS/togglePublish?slug='.$slug, array('query_string' => $query_string.'&sf_culture='.$culture)) ?></span>
        <span class="unpublished selected"><?php echo __('unpublished') ?></span>
      <?php endif; ?>
    </div>
    <div>
      Locking:
      <?php if ($page->locked_by != NULL): ?>
        <span class="locked selected"><?php echo __('locked') ?></span>
        <span class="unlocked"><?php echo link_to( __('unlock'), 'sfSimpleCMS/releaseLock?slug='.$slug, array('query_string' => $query_string.'&sf_culture='.$culture)) ?></span>
      <?php else: ?>
        <span class="locked"><?php echo link_to(__('lock'), 'sfSimpleCMS/acquireLock?slug='.$slug, array('query_string' => $query_string.'&sf_culture='.$culture)) ?></span>
        <span class="unlocked selected"><?php echo __('unlocked') ?></span>
      <?php endif ?>
    </div>
    <?php endif; ?>
    <div>
      <?php echo form_tag('sfSimpleCMS/done', 'name=cms_tools_done id=cms_tools_done class=open method=get') ?>
        <?php echo input_hidden_tag('slug', $slug, array()) ?>
        <?php echo submit_tag('Done', array()) ?>
      </form>
    </div>
  </div>
  ...
  <div id="tools" class="open">
    ...
    <?php echo form_tag('sfSimpleCMS/edit', 'name=cms_tools_update_page id=cms_tools_update_page class=open') ?>
      ...
      <div class="form_control">
        ...
        <?php echo input_tag('slug', $page->getSlug(), 'id=update_path class=wide') ?>
      ...
      <div class="form_submit">
        <?php echo button_to(__('delete'), 'sfSimpleCMS/delete?sf_culture='.$culture.'&slug='.$slug, array(
    ...
    <?php echo form_tag('sfSimpleCMS/edit', 'name=cms_tools_create_page id=cms_tools_create_page style=display:none') ?>
      
      <?php echo input_hidden_tag('sf_culture', $culture) ?>
      
      <div class="form_control">
        <label for="slug">Path:</label>
        <?php echo input_tag('slug', '', 'id=create_path class=wide autocomplete=off') ?>
      </div>
      ...
      <div class="form_control">
        ...
        <?php echo select_tag('position', options_for_select($page_names), 'id=create_position class=wide') ?>
      </div>
